...
public class ReusableMethods {
    ...
    public static void waitForVisibilityNew(WebDriver driver, WebElement element) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(GlobalVars.DefaultExplicitTimeOut));
    ...
    public static void waitForElementToBeClickableNew(WebDriver driver, WebElement element) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(GlobalVars.DefaultExplicitTimeOut));
